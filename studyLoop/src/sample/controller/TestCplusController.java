...
public class TestCplusController extends HelloViewController {
    ...
    private Questions[] questions = new Questions[]{
            new Questions("(1.6)Which of the options is the correct format for displaying information on the screen?", new String[]{"Console.Write()", "console.log()", "print()", "cout << \"Hello World!\""}),
            new Questions("(2.6)Without what the code will not work?", new String[]{"String", "Float", "Boolean", "main function"}),
            new Questions("(3.6)Which of these is the correct variable declaration?", new String[]{"int age; int age;", "int main", "int A", "int age; age = 20;"}),
            new Questions("(4.6)It can take one of two values true (true) and false (false)...", new String[]{"int",
                    "char", "short", "boolean"}),
            new Questions("(5.6)Each file must be started...", new String[]{"namespase std;", "class main{}", "int", "#include <iostream>"}),
